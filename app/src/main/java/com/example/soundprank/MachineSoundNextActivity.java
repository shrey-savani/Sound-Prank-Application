...
public class MachineSoundNextActivity extends AppCompatActivity {
    ...
    int[] machineCharacterImage = new int[]{
            R.drawable.hairtrimmer_c,
            R.drawable.fakemessage_c,
            R.drawable.fakecall_c,
            R.drawable.drill_c,
            R.drawable.gunfire_c,
            R.drawable.woodshaw_c,
            R.drawable.aircraft_c,
            R.drawable.carbrake_c,
            R.drawable.carhorn_c,
            R.drawable.cameraiphone_c,
            R.drawable.mouseclick_c,
            R.drawable.keyboard_c
    };

    int[] audioMachineCharacter = new int[]{
            R.raw.hair_trimmer_sound,
            R.raw.fake_message_sound,
            R.raw.fake_call_sound,
            R.raw.drill_sound,
            R.raw.gunfire_sound,
            R.raw.wood_saw_sound,
            R.raw.unmanned_aircraft_sound,
            R.raw.car_brake_sound,
            R.raw.car_horn_sound,
            R.raw.camera_iphone_sound,
            R.raw.mouse_click_sound,
            R.raw.key_board_sound
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_machine_sound_next);
        ...
        mp = MediaPlayer.create(getApplicationContext(), audioMachineCharacter[i]);

        imageView.setImageResource(machineCharacterImage[i]);
